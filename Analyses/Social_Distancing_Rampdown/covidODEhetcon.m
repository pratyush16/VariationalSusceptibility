function dsdt = covidODEhetcon(t,s)
    ...
    global lam de ga rh N xvec k2 drampup drampdown dmax p inidist data R0 i
    ...
    behetcon = R0(i)/(rh/de+1/ga)/k2;
    lam = behetcon*prox/data(i).pop*xvec*(rh*s(N+1:2*N)+s(2*N+1:3*N));   
